...
class RefineLikeResult:
    ...
    def plot(
        ...
        ax.plot(xx, pdf, linewidth=2, label="Fitted non-pathological density")
        ...
        if show_pathological_difference and counts.size > 0:
            ...
            ax.plot(mids, diff, linewidth=1, label="Observed - fitted")
...
if __name__ == "__main__":
    ...
    print(result.get_ri())
    if args.plot:
        ax = result.plot(show_pathological_difference=False)
